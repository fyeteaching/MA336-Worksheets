...
\NewDocumentCommand{\yesBG}{}{
  \checkoddpage
  \ifoddpage
  \backgroundsetup{
    contents={\rule[0em]{1.5pt}{\dimexpr \textheight+2\baselineskip}},
    position={14.25pc,-0.475*\textheight}
  }
  \else
  \backgroundsetup{
    contents={\rule[0em]{1.5pt}{\dimexpr \textheight+2\baselineskip}},
    position={12pc, -0.475*\textheight}
  }
  \fi
  \BgMaterial
}

\NewDocumentCommand{\restoreBG}{}{
  \cleardoublepage
  \backgroundsetup{
    opacity=1
  }
